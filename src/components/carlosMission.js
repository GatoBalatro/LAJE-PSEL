...
export const carlosPhases = [
  {
    ...
    carlos: ['...', 'Quem é você? Como acessou esse chat?'],
    choices: [
      ...
      { text: '> "Você sabe o que acontece com contadores que desviam dinheiro?"', da: -5, next: 1, eff: 'hostile' }
    ]
  },
  {
  ...
  },
  {
    ...
    responses: {
      empathy: '...Como você sabe disso? [pausa longa] O que você quer?',
  ...
  },
  {
    ...
    responses: {
      deal: '...Um apagão. Só isso? [longa pausa] E minha família fica fora disso?',
